...
namespace Project.Services
{
    ...
    public class LocalAiWebClient : IAiGenerationService
    {
        ...
        {
            // First, we construct a detaile dprompt injecting our dynamic profile varibles
            ...
            string taskRules = "Task: Generate exactly ONE immersive sentence whispering this rumor. No meta-text, no action text, no quotation marks.";
            ...
            // Second We format into a structurally standard JSON contract payload
            string jsonPayload = "{ " +
                                 $"\"model\": \"{ModelName}\", " +
                                 $"\"prompt\": \"{fullPrompt}\", " +
                                 "\"stream\": false " +
